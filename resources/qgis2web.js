...
map.getView().fit([6201500.184271, 7352230.167226, 6314930.465080, 7466219.913540], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Физическая карта Благовещенского района</h2>';
        return titleElement;
    })(),
